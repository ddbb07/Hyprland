...
local taskManager = 'kitty -c "$HOME/.config/kitty/btop.conf" btop'
...
-- Misc --
hl.env("EDITOR", "nano")
hl.env("BASH_SHARED_SCRIPT_PATH", "/home/davidb/Dokument/Kodning/Bash-Scripting/shared.sh")

-- XDG --
hl.env("XDG_CURRENT_DESKTOP", "Hyprland")
hl.env("XDG_SESSION_DESKTOP", "Hyprland")
hl.env("XDG_SESSION_TYPE", "wayland")
hl.env("XKB_DEFAULT_LAYOUT", "se")
...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd(taskManager))
...
hl.workspace_rule({ workspace = "0", monitor = "DP-3" })
